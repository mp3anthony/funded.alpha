...
export default function OfflinePage() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center min-h-[70vh] px-4 py-8 text-center relative">
      ...
      <div className="max-w-md w-full space-y-6 bg-surface border border-white/10 p-8 rounded-3xl backdrop-blur-md relative overflow-hidden shadow-2xl">
        ...
        <div className="mx-auto inline-flex items-center justify-center h-20 w-20 rounded-3xl bg-[#c8ff00]/10 border border-[#c8ff00]/25 text-[#c8ff00] animate-pulse">
        ...
        <div className="pt-2">
          <button
            onClick={handleRetry}
            className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[#c8ff00] text-black text-xs font-bold uppercase tracking-wider transition-all duration-200 hover:brightness-110 active:scale-[0.98] cursor-pointer"
          >
