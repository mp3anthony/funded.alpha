...
import { ArrowUpRight, Calendar, AlertCircle, CheckCircle2, Clock } from "lucide-react";
...
export const UpcomingBillsCard = React.memo(function UpcomingBillsCard({
  ...
  // Get next 5 upcoming or unpaid bills sorted by due date
        ...
        {upcomingBillsList.length === 0 ? (
          <div className="py-8 text-center flex flex-col items-center justify-center space-y-2.5">
            ...
            <div className="space-y-1">
              <p className="text-sm font-semibold text-neutral-400">No upcoming bills</p>
              <p className="text-xs text-neutral-500 font-sans max-w-[240px] mx-auto">
                Welcome! Start by adding your first bill to keep track of due dates.
              </p>
            </div>
          </div>
        ) : (
