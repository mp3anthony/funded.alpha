...
export default function BottomNav() {
  ...
  return (
    <nav 
      ...
      className="z-50 w-full shrink-0 border-t border-zinc-200/50 bg-[#111111]/85 backdrop-blur-lg dark:border-white/10 dark:bg-black/80 shadow-[0_-4px_24px_-4px_rgba(0,0,0,0.5)]"
    >
