...
export default function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 w-full shrink-0 border-t border-border bg-background/80 dark:bg-foreground/20 dark:bg-black/80 backdrop-blur-lg">
