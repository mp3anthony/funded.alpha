      ...
      >
        ...
        <form onSubmit={handleSave} className="flex flex-col flex-1 overflow-hidden">
          <div className="flex-1 overflow-y-auto p-5 md:p-6 space-y-5 md:space-y-6 font-sans">
            ...
            {success && (
              <div className="p-3.5 rounded-xl bg-[#c8ff00]/10 border border-[#c8ff00]/20 text-[#c8ff00] text-xs font-medium flex items-center gap-2">
            ...
            <div className="space-y-2">
              <label htmlFor="member-name" className="block text-xs font-bold tracking-wider uppercase text-neutral-400">
                Display Name
              </label>
              <input
                id="member-name"
                ...
                className="w-full px-4 py-3 rounded-xl bg-[#1a1a1a] border border-white/10 text-white text-sm font-medium focus:ring-2 focus:ring-[#c8ff00]/30 focus:border-[#c8ff00] outline-none transition-all disabled:opacity-50"
              />
              {!isNameEditable && (
            ...
            <div className="space-y-2">
              ...
              {role === 'owner' && member.role !== 'owner' && (
                <p className="text-[10px] text-[#c8ff00] leading-normal font-sans">
            ...
            {member.role !== 'owner' && (
              <div className="pt-4 border-t border-white/5 flex justify-between items-center">
                <div>
                  <h4 className="text-xs font-bold text-[#ff3d57] uppercase tracking-wider">Remove Member</h4>
                  <p className="text-[10px] text-neutral-500 mt-0.5 leading-normal">Revoke access and reassign their data.</p>
                </div>
                <button
                  type="button"
                  onClick={() => {
                  ...
                  className="px-3 py-2 rounded-xl bg-[#ff3d57]/10 hover:bg-[#ff3d57] text-[#ff3d57] hover:text-white border border-[#ff3d57]/20 text-xs font-bold transition-all flex items-center gap-1 cursor-pointer font-syne uppercase tracking-wider"
                >
          ...
          <div className="flex items-center gap-3 p-5 border-t border-white/10 font-sans shrink-0">
            ...
            <button
              ...
              className="flex-1 py-3 rounded-xl bg-[#c8ff00] text-black text-sm font-bold hover:brightness-110 active:scale-95 transition-all disabled:opacity-40 disabled:pointer-events-none flex items-center justify-center gap-1.5 cursor-pointer font-syne uppercase tracking-wider"
            >
